...
public partial class QueryDemoDataContext : Microsoft.SharePoint.Linq.DataContext {
	
	#region Extensibility Method Definitions
	partial void OnCreated();
	#endregion
	
	public QueryDemoDataContext(string requestUrl) : 
			base(requestUrl) {
		this.OnCreated();
	}
	...
	[Microsoft.SharePoint.Linq.ListAttribute(Name="Courses")]
	public Microsoft.SharePoint.Linq.EntityList<CoursesItem> Courses {
		get {
			return this.GetList<CoursesItem>("Courses");
		}
	}
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(CoursesItem))]
...
/// Create a new list item.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="Courses")]
public partial class CoursesItem : Item {
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="CourseCategory", Storage="_courseCategory", FieldType="Text")]
	public string CourseCategory {
		get {
			return this._courseCategory;
		}
		set {
			if ((value != this._courseCategory)) {
				this.OnPropertyChanging("CourseCategory", this._courseCategory);
				this._courseCategory = value;
				this.OnPropertyChanged("CourseCategory");
			}
		}
	}
}
...
public partial class MicroFeedBase : Item {
	...
	private System.Nullable<int> _mediaPreviewWidth;
	
	private System.Nullable<int> _mediaPreviewHeight;
	
	private System.Nullable<int> _mediaActionWidth;
	
	private System.Nullable<int> _mediaActionHeight;
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="MediaPreviewWidth", Storage="_mediaPreviewWidth", FieldType="Integer")]
	public System.Nullable<int> MediaPreviewWidth {
		get {
			return this._mediaPreviewWidth;
		}
		set {
			if ((value != this._mediaPreviewWidth)) {
				this.OnPropertyChanging("MediaPreviewWidth", this._mediaPreviewWidth);
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="MediaPreviewHeight", Storage="_mediaPreviewHeight", FieldType="Integer")]
	public System.Nullable<int> MediaPreviewHeight {
		get {
			return this._mediaPreviewHeight;
		}
		set {
			if ((value != this._mediaPreviewHeight)) {
				this.OnPropertyChanging("MediaPreviewHeight", this._mediaPreviewHeight);
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="MediaActionWidth", Storage="_mediaActionWidth", FieldType="Integer")]
	public System.Nullable<int> MediaActionWidth {
		get {
			return this._mediaActionWidth;
		}
		set {
			if ((value != this._mediaActionWidth)) {
				this.OnPropertyChanging("MediaActionWidth", this._mediaActionWidth);
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="MediaActionHeight", Storage="_mediaActionHeight", FieldType="Integer")]
	public System.Nullable<int> MediaActionHeight {
		get {
			return this._mediaActionHeight;
		}
		set {
			if ((value != this._mediaActionHeight)) {
				this.OnPropertyChanging("MediaActionHeight", this._mediaActionHeight);
